...
#
#      bash <(curl -sL https://raw.githubusercontent.com/filipegajo89/anki-tec/main/public/install_mac.sh)
#
...
open "https://github.com/filipegajo89/anki-tec/raw/main/public/tec-to-anki.user.js" 2>/dev/null || true
echo ""
